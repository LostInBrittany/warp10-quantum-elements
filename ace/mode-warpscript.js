...
ace.define('ace/snippets/warpscript', ["require","exports","module"], function(require, exports, module) {
  ...
  exports.snippets = [{
    name: 'fetch',
    content: "[ ${1:read_token} '${2:class}' { ${3} } ${4:NOW} ${5:1 h} ] FETCH\n"
  }, {
    name: 'find',
    content: "[ ${1:read_token} '${2:class}' { ${3} } ] FIND \n"
  }, {
    name: 'bucketize',
    content: '[ SWAP bucketizer.${1:max} ${2:NOW} ${3:5 m} ${4:0} ] BUCKETIZE \n'
  }, {
    name: 'map',
